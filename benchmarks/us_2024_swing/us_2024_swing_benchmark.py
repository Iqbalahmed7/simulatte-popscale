...
_STATE_CONTEXTS: dict[str, str] = {
    ...
    "georgia": (
        ...
        "votes and has become a genuine battleground state after Biden narrowly won it in "
        "2020 by just 0.2 points. The state is sharply divided: Atlanta metro (Fulton, "
        "DeKalb, Cobb, Gwinnett counties) leans Democratic, while rural Georgia and the "
        "broader suburbs remain Republican. Georgia has a large Black voter population "
        "(~32% of eligible voters), concentrated in Atlanta and the Black Belt. The state "
        "also has a large white evangelical Christian population and a fast-growing Latino "
        "community. Donald Trump carried Georgia in 2016 and campaigned hard to win it "
        "back in 2024, focusing on inflation, crime, border security, and economic growth "
        "in rural communities. Kamala Harris focused on abortion rights (Georgia has a "
        "six-week abortion ban), economic fairness, and democratic institutions. Key voter "
        "concerns span inflation and cost of living, public safety, reproductive rights, "
        "and economic opportunity both in Atlanta's tech sector and struggling rural counties."
    ),
    "arizona": (
        "The 2024 US presidential election is on November 5, 2024. Arizona has 11 electoral "
        "votes and flipped from Republican to Democratic in 2020 by 0.3 points, making it "
        "a true toss-up in 2024. The state's political landscape is diverse: the Phoenix "
        "metro is rapidly growing with new residents, retirees, and military families; "
        "Latino voters (~24% of eligible voters) are a major demographic across Phoenix, "
        "Tucson, and border counties; and rural Arizona, Native American communities, and "
        "conservative retirees round out the electorate. Donald Trump made border security "
        "and immigration enforcement his central message in Arizona, arguing that the Biden "
        "administration's border policies had failed the state. Kamala Harris focused on "
        "abortion rights — abortion access became a flashpoint in Arizona after a 2024 "
        "state Supreme Court ruling — as well as economic concerns and housing affordability. "
        "Key voter concerns include immigration and border policy, abortion rights, inflation "
        "and housing costs, water scarcity, and jobs in the semiconductor and tech sectors."
    ),
    "wisconsin": (
